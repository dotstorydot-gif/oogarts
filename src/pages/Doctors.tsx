        ...
        try {
            ...
            if ((!docs || docs.length === 0) || (!specs || specs.length === 0)) {
                ...
                if (!docs || docs.length === 0) {
                    ...
                    const { data: updatedDocs } = await supabase.from('doctors').select('*').order('name');
                    docs = updatedDocs;
                }
            }
